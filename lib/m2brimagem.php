...
// funções para redimensionamento
	...
	*/
	...
	{
		//corrigido para aceitar redimencionamento transparente
		//$corfundo = imagecolorallocate( $this->img_temp, $this->rgb[0], $this->rgb[1], $this->rgb[2] );
		$corfundo = imagecolorallocatealpha($this->img_temp, 255, 255, 255, 127);
...
//adiconado para corrigir fundo transparente
